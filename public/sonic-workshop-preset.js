...
(function (global) {
  ...
  global.MineradioSonicWorkshop = {
    ...
    themeForColor: workshopThemeForColor,
    themeColor: workshopThemeColor,
    normalizeTheme: normalizeWorkshopTheme,
    customThemeForRegions: workshopCustomThemeForRegions,
    regionsFromFx: workshopRegionsFromFx,
    paletteHexesFromCover: workshopPaletteHexesFromCover,
    coverHex: workshopCoverHex,
    cssToHex: cssColorToHex,
